...
public class AssertStatement extends BaseStatement {
  ...
  private final List<List<OperatorExpression>> disjuncts;
  private final Set<String> disjunctsEnsures;

  private final List<List<List<Statement>>> expanded;
  ...
  protected ReturnStatus execute(Map<Variable, Variable> paramMap, StringBuilder s,
    ...
    for (Variable v : variables) {
      ...
      OperatorExpression opE = new OperatorExpression(symbolTable, new Bool(),
        BinaryOperator.Equals, List.of(varExp, expression));
