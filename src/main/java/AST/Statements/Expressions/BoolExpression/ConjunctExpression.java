...
public class ConjunctExpression extends BoolExpression {

    public static final String CONJUCT = " && ";
    private final BoolExpression lhs;
    private final BoolExpression rhs;

    public ConjunctExpression(Random random, Map<String, Statement> symbolTable) {
    ...
    public static BoolExpression create(Random random, Map<String, Statement> symbolTable) {
        return new ConjunctExpression(random, symbolTable);
    }
}
