...
public class ModulusExpression extends Expression<Integer> {
    //Only integer values
    ...
    public ModulusExpression(Random random, Map<String, Statement> symbolTable) {
