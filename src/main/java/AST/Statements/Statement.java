...
public interface Statement {
  ...
  /**
   * Convert the current statement to multiple (at most 5) variations of the current statement via
  ...
  /**
   * Get the current statement in the form where there is no dead code (used after execution, hence
  ...
  /**
   * For any verification statement, return a mapping of correct verification strings to be replaced
   * by incorrect verification strings
   *
