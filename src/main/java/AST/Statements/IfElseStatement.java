...
public class IfElseStatement extends BaseStatement {
  ...
  private final Statement ifStat;
  private final Optional<Statement> elseStat;
  ...
  private IfElseStatement(SymbolTable symbolTable, Expression test, Statement ifStat,
    Optional<Statement> elseStat) {
    super();
