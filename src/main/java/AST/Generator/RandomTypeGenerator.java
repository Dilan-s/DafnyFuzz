...
public class RandomTypeGenerator {
  ...
  public static final List<BaseType> PRIMITIVE_TYPES = List.of(new Int(), new Bool(), new Real(),
    new Char());
  ...
  public List<Type> generateTypesWithoutCurrent(int noTypes, SymbolTable symbolTable,
    Type current) {
    typeDepth++;
