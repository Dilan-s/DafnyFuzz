...
public class RandomFunctionGenerator {
  ...
  private Function generateClassFunction(Type returnType, SymbolTable symbolTable,
    List<Type> argTypes) {
  ...
  public Function generateBaseFunction(Type returnType, SymbolTable symbolTable,
    List<Type> argTypes) {
