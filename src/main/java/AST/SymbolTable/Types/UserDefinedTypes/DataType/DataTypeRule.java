...
public class DataTypeRule implements UserDefinedType {
  ...
  private final Map<GenericType, Type> genericMap;
  ...
  public DataTypeRule(Type parentType, String ruleName, List<Type> fields,
    List<GenericType> generics, boolean init, Map<GenericType, Type> genericMap,
  ...
  public boolean equals(Object obj) {
    ...
    if (parentType == null || ruleName == null || dataTypeRuleOther.parentType == null
      || dataTypeRuleOther.ruleName == null || fields == null || dataTypeRuleOther.fields == null) {
      return true;
    }

    return dataTypeRuleOther.parentType.equals(parentType) && ruleName.equals(
      dataTypeRuleOther.ruleName) && dataTypeRuleOther.fields.equals(fields);
  }
  ...
  public String formatEnsures(String variableName, Object object) {
    ...
    for (int i = 0; i < fieldNames.size(); i++) {
      String e = fields.get(i)
        .formatEnsures(String.format("%s.%s", variableName, fieldNames.get(i)), val.get(i));
      if (e == null) {
        return null;
      }
      res.add(e);
