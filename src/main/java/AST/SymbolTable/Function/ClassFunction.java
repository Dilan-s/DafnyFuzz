...
public class ClassFunction extends Function {
  ...
  public ClassFunction(String name, Type returnType, List<Variable> args, SymbolTable symbolTable,
    DClass dClass) {
  ...
  public CallFunctionExpression generateCall(SymbolTable symbolTable) {
    ...
    CallFunctionExpression expression = new CallClassFunctionExpression(symbolTable, this, classExp,
      args);
    return expression;
  }
