...
public enum UnaryOperator implements Operator {
  Cardinality("|%s|", List.of(Args.SEQ, Args.DSET, Args.MULTISET, Args.DMAP, Args.DSTRING),
    new Int()) {
    @Override
  ...
  Is("is", List.of(Args.INT, Args.CHAR, Args.BOOL, Args.REAL, Args.DSTRING, Args.SEQ, Args.DSET,
    Args.MULTISET, Args.DMAP, Args.DARRAY, Args.TUPLE, Args.DATATYPE, Args.DCLASS, Args.TYPE_ALIAS),
    new Bool()) {
    @Override
    public String formExpression(List<Expression> args) {
