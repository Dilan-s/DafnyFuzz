...
javac -cp src/main/java/ -d ./out/ src/main/java/Main/MetamorphicProgramGeneration.java src/main/java/Main/CompareOutputs.java
...
while [ true ]; do
    ...
    echo "Test number $x"
    timeout -s SIGKILL $t java -cp out/ Main.MetamorphicProgramGeneration $x
    if [ $? -ne 0 ]
    then
